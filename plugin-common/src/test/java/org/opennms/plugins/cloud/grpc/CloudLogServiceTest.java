...
public class CloudLogServiceTest extends CloudLogServiceTestUtil {
    ...
    private GrpcExecutionHandler grpcExecutionHandler;
    ...
    public void setUp() {
        ...
        grpcExecutionHandler = new GrpcExecutionHandler(grpcLogEntryQueue);
        grpcExecutionHandlerSpy = Mockito.spy(grpcExecutionHandler);
        cloudLogService = new CloudLogService(executor, grpcLogEntryQueue, grpcExecutionHandlerSpy);
    }
