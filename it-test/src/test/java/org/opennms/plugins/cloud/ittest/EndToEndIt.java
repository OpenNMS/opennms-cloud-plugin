...
public class EndToEndIt {
    ...
    private void installAndStartPluginInOpenNms() {
        ...
        opennmsShell.runCommand("kar:install --no-start mvn:org.opennms.plugins.cloud.assembly/org.opennms.plugins.cloud.assembly.kar/1.0.2/kar");
    ...
    private void installAndStartPluginInSentinel() {
        ...
        // install plugin for core
        sentinelShell.runCommand("kar:install --no-start mvn:org.opennms.plugins.cloud.assembly/org.opennms.plugins.cloud.assembly.kar/1.0.2/kar");
